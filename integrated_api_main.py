...
async def send_error_callback(callback_url: str, route_number: str, error_message: str):
    """오류 콜백 전송"""
    callback_message = {
        "version": "2.0",
        "template": {
...
async def send_success_callback(callback_url: str, route_number: str, target_date: str, 
